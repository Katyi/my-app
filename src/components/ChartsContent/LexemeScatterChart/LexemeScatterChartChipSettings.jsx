...
function LexemeScatterChartChipSettings({
  variants=new Map(),
  exceptions,
  onUpdate,
  data
...
const allChips = getAllChartsChip(data.plantsConnection.edges, variants)
...
export default LexemeScatterChartChipSettings;